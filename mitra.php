        ...
        <div class="content-body">
            <div class="container-fluid mt-3">
               ...
               <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Form Master Mitra</h4>
                                <div class="basic-form">
                                    <form class="forms-sample" action="mitra/insert_mitra.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Nomor HP Mitra</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button type="submit" class="btn btn-dark" name="btnsavemitra">Save</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Data Table Mitra</h4>
                                        <div class="table-responsive">
                                            <table id="tablemitra" class="display" >
                                                ...
                                                <tbody>
                                                    ...
                                                    $id = htmlspecialchars($row['ID_MITRA'], ENT_QUOTES);
                                                    $nama = htmlspecialchars($row['NAMA_MITRA'], ENT_QUOTES);
                                                    $alamat = htmlspecialchars($row['ALAMAT_MITRA'], ENT_QUOTES);
                                                    $kota = htmlspecialchars($row['KOTA_MITRA'], ENT_QUOTES);
                                                    $nohp = htmlspecialchars($row['NOHP_MITRA'], ENT_QUOTES);
                                                    $email = htmlspecialchars($row['EMAIL_MITRA'], ENT_QUOTES);
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo $nama; ?></td>
                                                        ...
                                                        <td><button class=" btn btn-success" style="color: white;" id="tombolubah"  data-toggle="modal" data-target="#update" data-id="<?= $id; ?>" data-nama="<?= $nama; ?>" data-alamat="<?= $alamat; ?>" data-kota="<?= $kota;?>" data-nohp="<?= $nohp;?>" data-email="<?= $email;?>" >Update</button>
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Form Update data Mitra</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                
                  <form action="mitra/update_mitra.php" method="post">
                  <div class="modal-body">

                    <input type="hidden" name="id" id="id">
                  
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nama Mitra</label>
                      <div class="col-sm-9">
            ...
            <div class="modal fade" id="hapus">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="mitra/hapus_mitra.php" method="post">
                         <div class="modal-body ">
